...
const Profile: React.FC = () => {
    ...
    return (
        <Form
            ...
            className="!mx-auto !w-full !text-center lg:!w-1/2 px-0 border border-transparent sm:px-10 lg:px-12 md:px-32 2xl:px-28 sm:border-gray-200 pt-9 pb-4 rounded-lg"
            layout="vertical"
            initialValues={{
                username: "john_doe",
                firstName: "John",
