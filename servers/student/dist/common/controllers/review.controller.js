...
class ReviewController {
    ...
    putComment(req, res, next) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const newNotification = new notification_model_1.default({
                ...
                formatedDate: (0, date_format_1.default)(),
                receiver: [...review.class.lecturers]
            });
            ...
            io.sockets.in(req.body.reviewID).emit('notification', {
                username: review.joinedInfo.studentID,
            ...
            res.status(200).json({
                status: 'success',
                data: (_e = commentsInfo === null || commentsInfo === void 0 ? void 0 : commentsInfo.comments) !== null && _e !== void 0 ? _e : [],
            });
        });
    }
    getReviewById(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const review = yield review_model_1.default.findById(reviewID).populate('comments.sender').lean();
            if (!review) {
                return next(new app_error_1.default('Review not found', 404));
            }
    ...
    getReviews(req, res, next) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            }).populate('comments.sender').sort({ createdAt: -1 }).lean();
            res.status(200).json({
                status: 'success',
                data: {
                    reviews,
